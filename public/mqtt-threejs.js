...
load_geometries().then(() => {
    ...
    offsets.push(new THREE.Group());
    offsets[3].position.set(1.0465, 0.225, 0.087);
    joints[3].add(offsets[3]);
    offsets[3].add(joints[4]);

    offsets.push(new THREE.Group());
    offsets[4].position.set(0.2335, 0, 0.197);
    joints[4].add(offsets[3]);
    offsets[4].add(joints[4]);

    offsets.push(new THREE.Group());
    offsets[2].position.set(0.2335, 0, 0.197);
